...
Kind: `adapter`
Implementation binding: `js` via `implementation.yaml`.
...
Shape: `Boundary Adapter`: `boundary-adapter` (parsers, boundary validation, ports, effect adapters, and contract or boundary tests)
