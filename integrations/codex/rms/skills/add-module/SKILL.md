...
17. Define coordination state, deadlines, terminal states, subscription registry, effect lifecycle, retry count, golden timelines, and compensation only if the Workflow profile applies.
