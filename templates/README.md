...
Use these templates only where they improve discovery:

- `CONTEXT_README.md` for a bounded context.
- `MODULE_README.md` for a public or independently maintained module.
