...
4. State the public semantics that must be preserved:
   ...
   - artifact contracts and transformations, cross-module protocol automata, resource lifecycles, authority containment, and executable property observation/expression semantics.
