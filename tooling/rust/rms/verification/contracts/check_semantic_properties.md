...
- The command reports semantic property and fuzz targets, input-space openness, exact generators and runners, oracles, realization strategy, concrete evidence, and counterexample replay policy.
...
- executable realizations require exact runners, generated or exhaustive strategies require generators, and inspectable runners call their generator, semantic operation, and oracle;
