...
- `diagnose_report_includes_config_and_serializes_to_json` verifies `.rms/config.yaml` readiness is represented in the shared diagnose report and serializes for `rms diagnose --json`.
