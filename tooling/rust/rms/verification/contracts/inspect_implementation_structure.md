...
Rust symbol and effect regressions accept crate-visible associated methods, static domain metadata lookup, regex read queries, and standard owned-string operations. Public constructor evidence still requires a public constructor. Genuine filesystem metadata access and unresolved dynamic callbacks remain effectful.
