...
Promise: `plan-semantic-change` renders a self-contained advisory `rms/semantic-change/v0.1` prompt for laws, contracts, semantic-function authority bindings, machine structure, runnable surfaces, effects, and evidence obligations.
