...
- Declared generator: `src/main.rs#generate_malformed_artifact_cases`.
- Declared runner: `src/main.rs#schema_validation_reports_shape_errors`.

Expected result:

- Schema-violating RMS artifacts are rejected with diagnostics.
- The generator produced 32 malformed required-section shapes across null, boolean, numeric, sequence, and mapping substitutions; the runner rejected every case with at least one deterministic diagnostic.
