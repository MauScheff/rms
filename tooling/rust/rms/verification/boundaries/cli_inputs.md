...
Workbench config is operational input only. It may select provider, model, sandbox, and run-record defaults, but it cannot define module ownership, contracts, invariants, effects, or compatibility.
